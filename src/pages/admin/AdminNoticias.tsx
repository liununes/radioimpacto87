      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
             ...
             <CardContent className="p-8 space-y-6">
               ...
               <div className="flex gap-4">
                 <Input 
                   ...
                   className="flex-1 h-14 rounded-none border-gray-100 bg-gray-50 focus-visible:ring-primary font-medium" 
                 />
                 <Button onClick={handleScrape} disabled={isScraping || !scrapeUrl.trim()} className="h-14 px-10 rounded-none bg-secondary hover:bg-secondary/90 text-primary font-black uppercase tracking-widest text-[10px] shadow-lg shadow-yellow-400/10">
        ...
        <div className="lg:col-span-4 space-y-10">
           ...
           <Card className="rounded-none border-none shadow-xl bg-white text-slate-900 overflow-hidden">
             ...
             <CardContent className="p-8 pt-4 space-y-8">
               <div className="flex flex-wrap gap-2">
                 {categorias.map(cat => (
                   <div key={cat} className="group relative flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-none border border-gray-100/50 hover:bg-white text-slate-900 hover:shadow-md transition-all">
               ...
               <div className="pt-6 border-t border-gray-50 flex flex-col gap-3">
                 <Input value={novaCategoria} onChange={e => setNovaCategoria(e.target.value)} placeholder="NOME DA CATEGORIA..." className="h-12 rounded-none border-gray-100 bg-gray-50 font-black text-[10px] uppercase tracking-widest text-center" />
                 <Button onClick={handleAddCategoria} className="h-12 rounded-none bg-gray-100 text-primary border-none hover:bg-primary hover:text-white font-black uppercase text-[10px] tracking-widest">
                   Adicionar Nova
                 </Button>
               </div>
             </CardContent>
           ...
           <div className="space-y-6">
             ...
             <div className="space-y-4">
               {filtered.map(n => (
                 <Card key={n.id} className="group rounded-none border-none shadow-md overflow-hidden bg-white text-slate-900 hover:shadow-xl transition-all duration-300 cursor-default">
                   <CardContent className="p-4 flex gap-4">
                     <div className="w-20 h-20 rounded-none overflow-hidden bg-gray-100 shrink-0 shadow-inner">
                     ...
                     <div className="flex-1 flex flex-col justify-center min-w-0">
                        ...
                        <div className="flex items-center gap-3 mt-3">
                           <button onClick={() => handleEdit(n)} className="p-1 px-3 bg-gray-50 text-[9px] font-black uppercase text-primary rounded-none border border-gray-100 hover:bg-primary hover:text-white transition-all">Editar</button>
                           <button onClick={() => handleDelete(n.id)} className="p-1 px-3 bg-red-50 text-[9px] font-black uppercase text-red-500 rounded-none border border-red-100 hover:bg-red-500 hover:text-white transition-all">Excluir</button>
                        </div>
                     </div>
                   </CardContent>
                 </Card>
